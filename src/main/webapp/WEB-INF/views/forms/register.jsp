                    ...
                    <div class="panel-body">
                        <form:form method="post" action="${pageContext.request.contextPath}/register" modelAttribute="user">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <form:input class="form-control" path="surname" placeholder="Surname" type="text" />
                                </div> 
                                ...
                                <div class="form-group">
                                    <form:input class="form-control" path="passwordRepetition" placeholder="Repeat password" type="password"/>
                                </div> 
