INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'1', 'initialized', '1');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'1', 'started', '2');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'1', 'in progress', '3');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'1', 'almost done', '4');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'1', 'done', '5');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'1', 'closed', '6');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'1', 'problem', '7');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'0', 'inactive', '7');
INSERT INTO `project_management`.`status` (`active`, `name`, `sort_order`) VALUES (b'0', 'cancelled', '7');
